...
<body>
	<div id="ui" style="text-align: center;">
		<div class="user ">
				...
				<div class="container-fluid full ">
					<form action="regist"
						...
						<div class="form-group">
							<label for="firstName" class="col-md-3 control-label">用户名<span style="color:red">*</span></label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label for="password" class="col-md-3 control-label">密码<span style="color:red">*</span></label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label for="birthDate" class="col-md-3 control-label">姓名<span style="color:red">*</span></label>
							<div class="col-md-6">
						...
						<div class="form-group">
							<label for="birthDate" class="col-md-3 control-label">手机号<span style="color:red">*</span></label>
							<div class="col-md-6">
								<input name="phone" type="text" id="birthDate" placeholder="请输入手机号"
									class="form-control">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input name="mail" type="email" id="email" placeholder="请输入电子邮箱"
									class="form-control">
							</div>
						...
						<div class="form-group">
							<label for="birthDate" class="col-md-3 control-label">地址</label>
							<div class="col-md-6">
								<input name="wx" type="text" id="vx"  placeholder="地址"
									class="form-control">
							</div>
						</div>
			...
			<div class="footer">
				<a id="back_home" href="/"> 返回网站首页</a>

			</div>
		</div>
	</div>
<footer style="text-align: center;background-color: #111;">
	<hr>
