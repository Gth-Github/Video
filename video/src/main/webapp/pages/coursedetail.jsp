							...
							<div class="ctarea f-fl j-cht">
								<div class="u-coursetitle f-fl" id="auto-id-1509947716616">
									...
									<div class="f-cb margin-top-15">
										...
										<span class="cmt">观看人数(${course.hour }) </span> <br>
								...
								<div class="btnarea f-pa j-chbtnarea">
									...
									<c:if test="${isSelect == false }">
									   <c:choose>
										...
										<a class="learnbtn f-db f-cb j-joinBtn"> <span>立即订阅</span></a>
										</c:when>
											<c:otherwise>
									...
									<c:if test="${isSelect == true }">
										<a class="learnbtn f-db f-cb j-joinBtn"><span>取消订阅</span></a>
										<c:choose>
											<c:when test="${course.price eq 0 }">
												<a href="coursevideo?courseid=${course.id}"><span
													style="background: #ee6600; color: white; font-size: 20px; line-height: 45px; width: 160px; height: 45px; text-align: center; vertical-align: middle; display: inline-block;">去观看</span></a>
											</c:when>
											<c:otherwise>
												<a href="#"><span
													style="background: gray; color: white; font-size: 20px; line-height: 45px; width: 160px; height: 45px; text-align: center; vertical-align: middle; display: inline-block;">视频暂时下架</span></a>
											</c:otherwise>
										</c:choose>
									</c:if>
								</div>
