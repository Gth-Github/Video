    ...
    <div id="open">
        ...
        <div class="navBox">
            <ul>
                ...
                <li>
                    <h2 class="obtain">视频管理<i></i></h2>
                    <div class="secondary">
                        <h3><a href="allcourse?page=0" target="rigt_main" style="color: white;font-size: 13px;">查看所有视频信息</a></h3>
                        <h3><a href="coursede?" target="rigt_main" style="color: white;font-size: 13px;">添加视频信息</a></h3>
                    </div>
                </li>
                <li>
...
<div style="margin-top: 50px;text-align: center;">
                        <h3><a href="logoutadmin" style="font-size: 15px;color: white;">退出后台管理</a></h3>
                    </div>
        </div>
    </div>
</div>
