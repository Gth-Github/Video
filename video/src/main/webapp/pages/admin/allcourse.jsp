...
<body>
	<div>
		<div class="container"
			...
			<p style="font-size: 50px;text-align: center;">视频管理</p>
			<div class="container"
				...
				<table class="table table-striped" width="950">
					<tr>
						<td class="col-md-2 text-center">视频ID</td>
						<td class="col-md-2 text-center">视频名</td>
						<td class="col-md-2 text-center">视频介绍</td>
						<td class="col-md-2 text-center">视频评价</td>
						<td class="col-md-2 text-center">视频分类</td>
						<td class="col-md-2 text-center">操作</td>
						<td class="col-md-2 text-center">详情</td>
						<td class="col-md-2 text-center">删除视频</td>
					</tr>
					<c:if test="${courses.size()==0 }">
						<tr>
							<td colspan="5" style="font-size: 35px; text-align: center;">暂无视频
							</td>
						</tr>
					</c:if>
						...
						<tr>
							...
							<td class="col-md-2 text-center ">
										<a class="btn btn-danger delete"
											...
											href="javascript:removecourse(courseid='${order.id }')">删除视频</a>
									</td>
						</tr>
...
function removecourse(courseid){
	var r=confirm("确认要删除视频："+courseid+"?");
	if (r==true){
